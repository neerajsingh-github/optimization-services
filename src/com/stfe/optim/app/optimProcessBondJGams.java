...
import com.stfe.optim.excel.*;
    ...
    public class optimProcessBondJGams {
		...
		private String BondDeltaBkstTensor_BondRV_Net;
		private String BondDeltaBkstTensor_BondFx_Net;
		private String BondDeltaBkstTensor_BondPVClean_Net;
		private String BondDeltaBkstTensor_BondDebtClean_Net;
		...
		private boolean dummyDeltaCalcFlag=false;
		...
		///////////////////////////////////////////////////////////////////////////////
			...
			public void ojbfunc_optimize_loadBondExprJOM() {
				...
				this.oxl.genTxtFileFrom2DData(filepath, "DeltaDebtCleanForTilgungYearlyArr.txt", DeltaDebtClean );
			...
			private String ojbfunc_optimize_formBondFinLueckeConstraint(){ 
				...
				jom.setInputParameter("InitDeltaSchuldTotalVecArr", new DoubleMatrixND(DeltaSchuldTotalVecArr)  ); 
			...
			private void ojbfunc_optimize_addConstraintBondFinLuecke() { 
				...
				//---JG--- this.jom.addConstraint(finlckConstraint2);
			}
			public void ojbfunc_optimize_formBondFinLueckeConstraint_jGExpGDX() {
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(this.jom,"InitDeltaSchuldTotalVecArr", "InitDeltaSchuldTotalVecArr");
				
				//MatrixMonthsYear12EleONPrevYear ; // [2, 24]
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(this.jom,"MatrixMonthsYear12EleONPrevYear ", "MatMonthsYear12EleONPrevYear ");
				
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(this.jom,"MatrixRowVecMonths12EleON ", "MatRowVecMonths12EleON ");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(this.jom,"MatrixRowVecMonths12EleONPrevYear", "MatRowVecMonths12EleONPrevYear");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(this.jom,"MatrixRowVecMonths12EleONPrevYearInit2016", "MatRowVecMonths12EleONPrevYearInit2016");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(this.jom,"MatrixMonthsYear12EleON", "MatMonthsYear12EleON");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(this.jom,"NKBYearly", "NKBYearly");
			...
			private void ojbfunc_optimize_initBondDeltaBaukastenEBTensor(){
				...
				System.out.println(" ojbfunc_optimize_initformBondDeltaBaukastenTensor: Begin to get DeltaBaukasten Tensor ... ");
    			...
    			System.out.println("All fullFileTensorTX : DeltaBaukasten-Tensor file : " +   fullFileTensorTX );
    			System.out.println("Slice fullFileReducedTensorTXTM: DeltaBaukasten-Tensor file : " +   fullFileReducedTensorTXTM );
				...
				if (methodDBKTensor == 1) {
		    		...
		    		if (!forceGenTensor) {
		    			...
		    			if ( optimValidateFile.validFile(fullFileTensorTX) ) {
		    				...
		    				System.out.println("*** Restoring the fullFileTensorTX : DeltaBaukasten-Tensor file *** " +   fullFileTensorTX );
		    				...
		    				if (!changedConfig) {
		    					if ( optimValidateFile.validFile(fullFileReducedTensorTXTM) ) {
		    						System.out.println("*** Restoring the Slices from DeltaBaukasten-Tensor file *** " +   fullFileReducedTensorTXTM );		    					
		    		...
		    		*/
		    		...
		    		if (forceGenTensor) {
		    			System.out.println("*** Can not restore the DeltaBaukasten-Tensor file! Building the Tensor... *** " );	
		    		...
		    		if (forceGenTensor || changedConfig )  {
		    			System.out.println("4D-Struct BondDeltaBkstTensor4DTxAll : Tab1 "+ BondDeltaBkstTensor4DTxAll.length + " : Tab2=" + BondDeltaBkstTensor4DTxAll[0].length + " : Row=" + BondDeltaBkstTensor4DTxAll[0][0].length + " : Col=" + BondDeltaBkstTensor4DTxAll[0][0][0].length  );
		    			System.out.println("4D-Struct this.BondDeltaBkstTensor4DTM : Tab1 "+ this.BondDeltaBkstTensor4DTM.length + " : Tab2=" + this.BondDeltaBkstTensor4DTM[0].length );		
			...
			private void ojbfunc_optimize_loadJOM_EigenBestandBondTensorOpt(){
				...
				*/
				...
				//-- Required in Env --//
				this.BondDeltaBkstTensor_BondRV_Net =  "( (BondsRV2DOpt) - (" + BondDeltaBkstTensor_BondRV + ") )"; //-- BondRV - BondTensor  -- [35x60x31 ] //
				this.BondDeltaBkstTensor_BondFx_Net =  "( (BondFxRV2DOpt) - (" + BondDeltaBkstTensor_BondFx + ") )";  //[35x60x31 ] --//
				this.BondDeltaBkstTensor_BondPVClean_Net = "( (BondsRV2DPVCleanOpt) - (" + BondDeltaBkstTensor_BondPVClean + ") )"; //-- [35x60x1 ] --//
				this.BondDeltaBkstTensor_BondDebtClean_Net = "( (BondsRV2DDebtCleanOpt) - (" + BondDeltaBkstTensor_BondDebtClean + ") )"; // -- [35x60x1 ] --//
...
////////////////////////////////////////////////////////////////////
			...
			private String ojbfunc_optimize_formEigenBestandConstraintBond(){ 
				...
				*/
				...
				//--- wrong -- do not sum DVBondDelta to make it scalar --//
				// --- Apply sumproduct instead of matrix multiplication to get rid of issue -- "main" java.lang.IndexOutOfBoundsException: Index: 0, Size: 0 ---///
				// -- BondExprConstraint = "EBDVBond * ( "+ BondExprConstraint + ")"; --- should be replaced ---//
				//-- replicate a row Vector along diagonal of a square matrix --//
				...
				this.jom.setInputParameter("DeltaEBGwsYearlyNumYear", "DeltaEBGwsYearly(all, 0:NumYearIdx)" );
				
				//BondExprConstraint = "( DeltaEBGwsYearly(all, 0:NumYearIdx)) + ( EBAuslaufendYearlyNumYear) + ( " + EBDVBondDelta + " )";
				BondExprConstraint = "((0.001) * DeltaEBGwsYearlyNumYear) + ((0.001) * EBAuslaufendYearlyNumYear) + ( " + EBDVBondDelta + " )";  // -- ?? Million /Billion --???//
				this.functUtil.ojbfunc_optimize_dispDVExpr(this.jom, BondExprConstraint, "BondExpr-Constraint-DispFinal");
			...
			public void ojbfunc_optimize_formEigenBestandConstraintBond_jGExpGDX() { 
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"TransformedBondWeightKey", "TransformedBondWeightKey");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"DeltaMatrixInstrNumYearEB", "DeltaMatrixInstrNumYearEB");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"DeltaMatrixInstrNumYearEBTNS", "DeltaMatrixInstrNumYearEBTNS");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"DeltaEBGwsYearlyNumYear", "DeltaEBGwsYearlyNumYear");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"EBAuslaufendYearlyNumYear", "EBAuslaufendYearlyNumYear");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"MatrixColVecNumYearReduction", "MatColVecNumYearReduce");
			}
			

			private void ojbfunc_optimize_addConstraintEigenBestandBond(){  
				
				//--JG--  Migrated to JGams; // ---//
				...
				//--JG-- this.jom.addConstraint(BondExprConstraint2);
			...
			private void ojbfunc_optimize_addConstraintEigenBestandBond_v0_OLD_BUGGY(){
			...
			public void ojbfunc_optimize_addConstraintBondSwapFxRisk() { 
				...
				// --- JGAMS--   //  this.jom.addConstraint(SwapFxRiskConstStr);
			...
			public void ojbfunc_optimize_setupJOMBondSwapFxRisk_jGExpGDX() { 
				
				 
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"BondFxRV2DOpt", "BondFxRV2DOpt");
				...
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"FxRiskFullOpt", "FxRiskFullOpt");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"SchuldFullOpt", "SchuldFullOpt");
				
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"SwapsRV2DDebtCleanOpt", "SwapsRV2DDebtCleanOpt");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"MatrixColVecMonthsNumYearReduction ", "MatColVecMonthsYearReduction");
			...
			public void ojbfunc_optimize_addConstraintBondVol() {
				...
				//-- JGAMS--- Migrated to jGams; //---//
				
			}
			
			public void ojbfunc_optimize_addConstraintBondVol_jGExpGDX() { 
				com.stfe.optim.jgams.optimExportGDXJGams.exportGDXMatrix2D(this.UpLimitBondVol, "upBondVolConstraint",  false);
				com.stfe.optim.jgams.optimExportGDXJGams.exportGDXMatrix2D(this.DnLimitBondVol, "downBondVolConstraint",  false);
			}
			...
			public void ojbfunc_optimize_formBondSwapMehrkostenObjFunctExp_jgExpGDX() { 
				...
				System.out.println("BondDeltaBkstTensor4DTMEff struct: row/col/tab/fd4/:  " + this.BondDeltaBkstTensor4DTMEff.length + " : "+ this.BondDeltaBkstTensor4DTMEff[0].length + " : "+ this.BondDeltaBkstTensor4DTMEff[0][0].length+ " : "+ this.BondDeltaBkstTensor4DTMEff[0][0][0].length);
				com.stfe.optim.jgams.optimExportGDXJGams.exportGDXMatrix4D(this.BondDeltaBkstTensor4DTMEff, "BondDeltaBkstTensor4DTMEff",  false);
				
				
				/*
				double[][][][] BondDeltaBkstTensor_BondRV_5_35 =  (double[][][][]) jom.parseExpression("BondDeltaBkstTensor_BondRV_5_35").evaluateConstant().toArray();  
				com.stfe.optim.jgams.optimExportGDXJGams.exportGDXMatrix4D(BondDeltaBkstTensor_BondRV_5_35, "BondDeltaBkstTensor_BondRV_5_35",  false);
				
				double[][][][] BondDeltaBkstTensor_BondFx_43_73 =  (double[][][][]) jom.parseExpression("BondDeltaBkstTensor_BondFx_43_73").evaluateConstant().toArray();  
				com.stfe.optim.jgams.optimExportGDXJGams.exportGDXMatrix4D(BondDeltaBkstTensor_BondFx_43_73, "BondDeltaBkstTensor_BondFx_43_73",  false);

				double[][][][] BondDeltaBkstTensor_BondPVClean_2_2 =  (double[][][][]) jom.parseExpression("BondDeltaBkstTensor_BondPVClean_2_2").evaluateConstant().toArray();  
				com.stfe.optim.jgams.optimExportGDXJGams.exportGDXMatrix4D(BondDeltaBkstTensor_BondPVClean_2_2, "BondDeltaBkstTensor_BondPVClean_2_2",  false);

				double[][][][] BondDeltaBkstTensor_BondDebtClean_1_1 =  (double[][][][]) jom.parseExpression("BondDeltaBkstTensor_BondDebtClean_1_1").evaluateConstant().toArray();  
				com.stfe.optim.jgams.optimExportGDXJGams.exportGDXMatrix4D(BondDeltaBkstTensor_BondDebtClean_1_1, "BondDeltaBkstTensor_BondDebtClean_1_1",  false);
				*/			
				...
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom, "BondDeltaBkstTensor_BondRV_5_35", "BondDeltaBkstTensor_BondRV_5_35"); 
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom, "BondDeltaBkstTensor_BondFx_43_73", "BondDeltaBkstTensor_BondFx_43_73");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom, "BondDeltaBkstTensor_BondPVClean_2_2", "BondDeltaBkstTensor_BondPVClean_2_2");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom, "BondDeltaBkstTensor_BondDebtClean_1_1", "BondDeltaBkstTensor_BondDebtClean_1_1");
				...
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"BondsRV2DDebtCleanOpt", "BondsRV2DDebtCleanOpt");
				
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"BestandFullOpt", "BestandFullOpt");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSymbolInGDX(jom,"PVCleanOpt", "PVCleanOpt");
			...
			/////////////////////////////////////////////////////////////////////	
			public void ojbfunc_optimize_ruleConfig_jgExpGDX() {   
				...
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSAsScalarInGDX(this.jom, (double) this.ruleConf.numYears, "numYears");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSAsScalarInGDX(this.jom, (double) (this.ruleConf.numYears * 12), "numMonths");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSAsScalarInGDX(this.jom, (double) this.ruleConf.numDateRows, "numDates");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportJOMSAsScalarInGDX(this.jom, (double) this.ruleConf.numSRVRawRowsPerDate, "numSRVRowsPerDate");
				...
				com.stfe.optim.jgams.jgUtilJomGams.jgExportIntAsSetInGDX((int) this.ruleConf.numYears, "numYears");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportIntAsSetInGDX((int) (this.ruleConf.numYears * 12), "numMonths");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportIntAsSetInGDX((int) this.ruleConf.numDateRows, "numDates");
				com.stfe.optim.jgams.jgUtilJomGams.jgExportIntAsSetInGDX((int) this.ruleConf.numSRVRawRowsPerDate, "numSRVRowsPerDate");
			...
			public void ojbfunc_optimize_jgExpGDX_exportBondsAll() {
				com.stfe.optim.jgams.jgUtilJomGams.jgInitGDXSessionForJOPS();
				
				//--Mehrkosten--//
				this.ojbfunc_optimize_formBondSwapMehrkostenObjFunctExp_jgExpGDX();
				com.stfe.optim.jgams.JGamsEnv.GDXDump("opti_jops_GDX_ObjfMehrkosten");
				com.stfe.optim.jgams.JGamsEnv.DBClean();
				
				//VOL
				ojbfunc_optimize_addConstraintBondVol_jGExpGDX();
				com.stfe.optim.jgams.JGamsEnv.GDXDump("opti_jops_GDX_ConstBondVol");
				com.stfe.optim.jgams.JGamsEnv.DBClean();

				//--FXRisk--//
				ojbfunc_optimize_setupJOMBondSwapFxRisk_jGExpGDX();
				com.stfe.optim.jgams.JGamsEnv.GDXDump("opti_jops_GDX_ConstBondFXRisk");
				com.stfe.optim.jgams.JGamsEnv.DBClean();
								
				//--Eigenbestand--//
				ojbfunc_optimize_formEigenBestandConstraintBond_jGExpGDX();
				com.stfe.optim.jgams.JGamsEnv.GDXDump("opti_jops_GDX_ConstBondEigenbestand");
				com.stfe.optim.jgams.JGamsEnv.DBClean();
				
				//--FinLuecke --//
				ojbfunc_optimize_formBondFinLueckeConstraint_jGExpGDX();
				com.stfe.optim.jgams.JGamsEnv.GDXDump("opti_jops_GDX_ConstBondFinluecke");
				com.stfe.optim.jgams.JGamsEnv.DBClean();
				
				ojbfunc_optimize_ruleConfig_jgExpGDX();
				com.stfe.optim.jgams.JGamsEnv.GDXDump("opti_jops_GDX_RuleConfig");
				com.stfe.optim.jgams.JGamsEnv.DBClean();
...
/////////////////////////////////////////////////////////////////////
		...
		private void  ojbfunc_optimize_Kosten_objectiveFunctionBond() {
				...
				String BondSwapMehrKosten = ojbfunc_optimize_formBondSwapMehrkostenObjFunctExp(); // Migrated to JGams //
		...
		// -- ojbfunc_optimize_ProcessBondJOM-GAMS --//
		public void ojbfunc_optimize_ProcessBondJOM_JGams(optimSolveFunctApp appMainObj) {
			
			//-- InvokeSolver; configure the constraints, invokeSolver --//
			//-- Not required -- 
			boolean onTestRoutineReturn = false;/// 
			boolean onInvokeSolver=false;
			this.dummyDeltaCalcFlag = false; //-- true for dummy Delta data --//
			///////////////////////////////////////
			...
			//----------------------------------------------//
			if (jGAMSFlag) {
				//-- export GDX data for GAMS model --//
				ojbfunc_optimize_jgExpGDX_exportBondsAll();
			}
			...
			System.out.println ("** Bonds optimization input data generated as GDX to be solved on GAMS. Optimization for : " +  (this.numYearOpti) + " Done!");
