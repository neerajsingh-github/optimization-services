 ...
 */
	...
	////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////
    public class defOptimAppXLSpecsTillAug2017 {
    	...
    	private static final String[][] bauKastenRawValuesArchSpecs = {    		
    		{"srv_MetaColVals_SWAPS_RawValues","A","1","CD","1", "STRING"}, //Starting from 31.01.2017
    		{"srv_DataPort_SWAPS_RawValues","B","2","B","416977", "STRING"},  // till 31.12.2067 row=416977
    	...
    	private static final String[][] bauKastenRawValuesArchSpecs_Part1 = {    	// till 31.12.2067 row=416977
    		...
    		{"srv_DataPort_Bk_SWAPS_RawValues_Part1","B","2","B","75000", "STRING"},  
    		{"srv_Date_Bk_SWAPS_RawValues_Part1","A","2","A","75000", "DATE"},
    	...
    	private static final String[][] bauKastenRawValuesArchSpecs_Part3 = { //Total rows=416977    	 
    	...
    	private static final String[][] bauKastenRawValuesArchSpecs_Part4 = { //Total rows=416977    	 
    	...
    	private static final String[][] bauKastenRawValuesArchSpecs_Part5 = { //Total rows=416977    	 
    	...
    	private static final String[][] bauKastenRawValuesArchSpecs_Part6 = { //Total rows=416977    	 
    	...
    	*/
    	...
    	private static final String[][] MarketValues_PMV = {   
    		...
    		{"m_pmv_REF_PC_SENSI","EA","2","FE","325", "NUM"}		// Ref-PC-Sensi 	AI:BM->EA:FE 
    	};    	
